import { TrendingDown, TrendingUp, AlertCircle, CheckCircle2, Clock, FileText, DollarSign, AlertTriangle, Hash } from "lucide-react";
...
export function LossTab() {
  ...
  return (
    <div className="space-y-5" style={{ fontFamily: font }}>
      ...
      {/* Year-by-Year */}
      <SectionCard title="Year-by-Year Loss Summary" accent={N} icon={<FileText size={13}/>} noPad>
