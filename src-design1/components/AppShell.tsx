...
const NAV_BASE = [
  ...
  { id: "notes",         label: "Notes",          icon: FileText,        path: "/notes",         roles: ["uw","sr-uw","lead","director"] as RoleId[] },
      ...
      >
        ...
        >
          <div
            ...
            style={{ width: 30, height: 30, background: N }}
          >
            <GraduationCap size={17} color={G} />
          </div>
          {!sidebarCollapsed && (
            <div className="flex-1 min-w-0">
              <p style={{ fontSize: "0.74rem", fontWeight: 800, color: N, lineHeight: 1.15, letterSpacing: "0.01em" }}>United</p>
              <p style={{ fontSize: "0.74rem", fontWeight: 800, color: N, lineHeight: 1.15, letterSpacing: "0.01em" }}>Educators</p>
            </div>
          )}
        ...
        {user && (
          <div className="px-2.5 pt-3 pb-2 shrink-0">
            <div
              ...
              style={{ background: roleColor.bg, border: `1px solid ${roleColor.border}`, justifyContent: sidebarCollapsed ? "center" : "flex-start", borderRadius: 4 }}
            >
              <span style={{ color: roleColor.text }}>{roleColor.icon}</span>
              {!sidebarCollapsed && (
                <span style={{ fontSize: "0.56rem", fontWeight: 800, color: roleColor.text, textTransform: "uppercase", letterSpacing: "0.07em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                  {user.roleLabel}
                </span>
              )}
            </div>
      ...
      <div className="flex flex-col flex-1 min-w-0 h-screen">
        ...
        >
          ...
          <button
            ...
            style={{ width: 36, height: 36, border: `1px solid ${BD}`, borderRadius: 6 }}
          >
          ...
          <button
            ...
            style={{ width: 36, height: 36, border: `1px solid ${BD}`, background: searchOpen ? `${N}0C` : "white", borderRadius: 6 }}
          >
          ...
          <div className="relative shrink-0">
            <button
              ...
              style={{ border: `1px solid ${BD}`, background: quickOpen ? `${N}0C` : "white", borderRadius: 6 }}
              title="Quick Actions"
            >
              ...
              <div className="absolute right-0 mt-2 z-50"
                ...
                {[
                  ...
                  <button key={i}
                    ...
                    style={{ borderBottom: i < 3 ? `1px solid ${BDL}` : "none", borderRadius: 6 }}>
          ...
          <div className="relative shrink-0">
            <button
              ...
              style={{ border: `1px solid ${BD}`, borderRadius: 6 }}
            >
            ...
            {alertPop && (
              ...
              >
                ...
                <div className="px-4 py-2.5 text-center" style={{ background: "#F0F3F8" }}>
                  <button style={{ fontSize: "0.70rem", fontWeight: 700, color: "#005B99", borderRadius: 6 }}>View all alerts</button>
                </div>
              </div>
            )}
          </div>
            ...
            <div className="relative">
              ...
              {search && (
                <button
                  ...
                  style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", borderRadius: 6 }}
                >
                  <X size={13} color={TT} />
                </button>
              )}
