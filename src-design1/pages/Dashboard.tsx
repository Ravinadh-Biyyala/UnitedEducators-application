    ...
    >
      <div className="px-4 sm:px-6 lg:px-8 py-5 sm:py-7 space-y-5 sm:space-y-6"
        ...
        <PageRegister
          ...
          respond={(sid) => {
            ...
            if (sid === "urgent") return [{ id: newId(), role: "agent", kind: "viz", ts: now(), viz: {
              ...
              items: [
                { ok: false, label: "Brookfield Day School — quote ready", sub: "SUB-7829 · due today" },
                { ok: false, label: "Austin ISD — missing questionnaire", sub: "SUB-7831 · overdue" },
                { ok: false, label: "Seattle PS — safety questionnaire", sub: "SUB-7835 · 2 days" },
              ],
            } }];
            return;
          }}
        ...
        <div className="space-y-4 sm:space-y-6">
            ...
            {/* ── PIPELINE (modern SVG combo chart) ──────────────────────── */}
            <SectionCard title="Submission Pipeline — Last 6 Months"
              icon={<Activity size={13}/>} accent={G}>
