        ...
        >
          ...
          {!sidebarCollapsed && (
            <button
              ...
              onClick={() => setSidebarOpen(false)}
              style={{ width: 26, height: 26, border: `1px solid ${BDL}`, borderRadius: 6 }}
            >
              <X size={14} color={TT} />
            </button>
          )}
                ...
                >
                  ...
                  <div className="px-4 py-3 space-y-1">
                    <button className="w-full flex items-center gap-2.5 px-3 py-2 hover:bg-slate-50 transition-colors text-left"
                      style={{ fontSize: "0.78rem", color: "#1A2530", borderRadius: 6 }}>
                    ...
                    <button
                      ...
                      style={{ fontSize: "0.78rem", color: "#B91C1C", fontWeight: 600, borderRadius: 6 }}>
