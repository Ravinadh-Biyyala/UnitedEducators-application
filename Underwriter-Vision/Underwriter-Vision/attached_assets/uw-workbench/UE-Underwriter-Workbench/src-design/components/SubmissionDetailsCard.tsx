...
import {
  Copy, Check, AlertCircle, Mail, Phone, TrendingUp, Calendar,
...
function MiniBar({ pct, color = N }: { pct: number; color?: string }) {
  return (
    <div style={{
      width:64, height:4, background:"#E5E7EB", borderRadius:3, overflow:"hidden",
    }}>
      <div style={{
      ...
      <div className="grid grid-cols-1 md:grid-cols-3" style={{ borderBottom:`1px solid ${BD}` }}>
        <div style={{ borderRight:`1px solid ${BDL}` }}>
          <SectionCard title="Identification" healthDot={OK}
            ...
            <DetailRow last label="Priority"
              value={<StatusPill label="High" dotColor={WARN} bg="#FEF3C7" text="#92400E"/>}/>
          </SectionCard>
        </div>

        <div style={{ borderRight:`1px solid ${BDL}` }}>
          <SectionCard title="Dates & SLA" healthDot={WARN}
            ...
            <DetailRow label="Need-by"
              value={<span style={{ color:BAD, fontWeight:700 }}>Apr 28 · 12d</span>}/>
            <DetailRow last label="SLA progress"
              value={
                <span className="inline-flex items-center gap-2">
                  <span style={{ fontSize:"0.74rem", color:TM, fontWeight:700 }}>58%</span>
                  <MiniBar pct={58} color={WARN}/>
                </span>
              }/>
          </SectionCard>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3" style={{ borderBottom:`1px solid ${BD}` }}>
        <div style={{ borderRight:`1px solid ${BDL}` }}>
          <SectionCard title="Premium" healthDot={OK}
            ...
            <DetailRow label="Indicated change"
              value={
            ...
            <DetailRow last label="Commission rate" value="12%"/>
          </SectionCard>
        </div>
        ...
        <div style={{ borderRight:`1px solid ${BDL}` }}>
          <SectionCard title="Decision & Authority" healthDot={WARN}
            ...
            <DetailRow label="Referrals open"
              value={
                <span>1 <span style={{ fontSize:"0.7rem", color:TT, fontWeight:400 }}>(manager)</span></span>
              }/>
        ...
        <div>
          <SectionCard title="Compliance & Documents" healthDot={BAD}
            ...
            <DetailRow label="Financials FY24"
              value={
                <span className="inline-flex items-center gap-1.5">
                  <Check size={12} color={OK} strokeWidth={3}/>
                  <span style={{ color:OK, fontWeight:700 }}>On file</span>
            ...
            <DetailRow label="Cyber supp."
              value={
                <span className="inline-flex items-center gap-1.5">
                  <AlertCircle size={12} color={BAD}/>
                  <span style={{ color:BAD, fontWeight:700 }}>Missing</span>
                </span>
              }/>
            <DetailRow last label="OFAC screening"
              value={
                <span className="inline-flex items-center gap-1.5">
                  <Check size={12} color={OK} strokeWidth={3}/>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3">
        <div style={{ borderRight:`1px solid ${BDL}` }}>
          <SectionCard title="Member"
            ...
            <DetailRow label="Segment" value="K-12 · Private · Day"/>
            <DetailRow label="Enrollment" value="842 students"/>
            <DetailRow last label="Member since" value="Aug 15, 2019"/>
          </SectionCard>
        </div>
        ...
        <div style={{ borderRight:`1px solid ${BDL}` }}>
          <SectionCard title="Broker"
            ...
            <DetailRow label="Office" value="Stamford, CT"/>
            <DetailRow label="Producer code" copyValue="MMA-NE-0427" value="MMA-NE-0427"/>
            <DetailRow label="Appointment"
              value={<span style={{ color:OK, fontWeight:700 }}>Active</span>}/>
            <DetailRow last label="YTD bound"
              value={
                <span>$4.2M{" "}
                  <span style={{ fontSize:"0.7rem", color:TT }}>· 87% hit</span>
                </span>
              }/>
          </SectionCard>
        </div>
